...
class _Collector:
    ...
    def pytest_runtest_logreport(self, report):
        ...
        cat_map = {
            "TestCatalogue":         "A. Catalogue & Search",
            "TestTools":             "B. Tools",
            "TestSessionMemory":     "C. Session Memory",
            "TestGuardrails":        "D. Guardrails",
            "TestContext":           "E. Context",
            "TestErrorHandling":     "F. Error Handling",
            "TestStreaming":         "G. Streaming",
            "TestFrontendConnectivity": "H. Frontend",
            "TestProductsEdge":      "I. Products Edge",
            "TestConfig":            "J. Config",
            "TestToolsEdge":         "K. Tools Edge",
            "TestAgentEdge":         "L. Agent Edge",
            "TestTracing":           "M. Tracing",
        }
...
if __name__ == "__main__":
    ...
    test_file = str(_HERE / "tests" / "test_all_51.py")
    args = [test_file, "-v", "--tb=short", "--no-header", "-q"]
